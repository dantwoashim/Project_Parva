        ...
        queue.append(
            {
                ...
                "url": row.get("url"),
                "source_archive_ref": f"moha_official_{row.get('bs_year')}",
                "source_archive_policy": "private_archive_not_in_public_artifact",
                "source_available_for_review": local_exists,
