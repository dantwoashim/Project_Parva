...
class MerkleTree:
    ...
    def __init__(self, leaves: List[Dict[str, Any]]):
        ...
        # Create leaf hashes
        self.leaves = leaves
        self.leaf_hashes = [sha256_hash(json.dumps(leaf, sort_keys=True)) for leaf in leaves]
...
def get_festival_proof(snapshot_path: Path, year: int, festival_id: str) -> Optional[MerkleProof]:
    """
