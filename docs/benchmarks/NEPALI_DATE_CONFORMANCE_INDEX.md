...
| `YARSA-252` | `yarsa/nepal-compliance` | [Issue #252](https://github.com/yarsa/nepal-compliance/issues/252) | Payroll date risk | `business_wedge` | Partial | No | Open | Manual payroll investigation target | Parva tracks it as reported payroll date-risk evidence requiring reproduction. |
...
- Project Parva tracks public Nepali date regression cases as conformance
  fixtures.
- Project Parva provides a Nepal compliance conformance profile for
  source-drift, conversion-boundary, invalid-date, future-review, and payroll
  date-risk checks.
