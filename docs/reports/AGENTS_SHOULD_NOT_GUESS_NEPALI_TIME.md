---
status: public-beta
audience: vendor-systems
---

# Agents Should Not Guess Nepali Time
...
Unverified model output and static date tables are unsafe for this domain
because they can produce a plausible date without source tier, supported range,
...
The current tracked benchmark result was created by:
