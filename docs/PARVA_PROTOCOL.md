...
Version: `parva-protocol-0.1.0`

It defines draft specs, schemas, compatibility levels, conformance reports, hash-only preview credentials, registry layout, offline bundle format, and governance documents.
