...
- Do not claim guaranteed future accuracy or broad future-calendar certainty.
...
When changing routing, docs, future-BS behavior, or examples, run focused checks for:
