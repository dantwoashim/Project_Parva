const ROUTE_MANIFEST = [
  ...
  },
  {
    ...
    tier: 'support',
    keywords: 'method evidence provenance review',
  ...
  },
  {
    id: 'truth-lab',
    to: '/truth-lab',
    labelKey: 'common.truthLab',
    tier: 'beta',
    keywords: 'authority comparison dispute atlas conflicts evidence boundaries',
    metaKey: 'search.command.truthLab.meta',
    footerGroup: 'utilities',
  },
  {
    id: 'about',
