...
export function orderPlatformsForDevice(recommendedPlatform) {
  return ['apple', 'google'].sort((left, right) => (
    left === recommendedPlatform ? -1 : right === recommendedPlatform ? 1 : 0
  ));
}

export function sortSavedIntegrations(integrations = []) {
