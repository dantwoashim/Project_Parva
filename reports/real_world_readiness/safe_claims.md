...
- The MCP server supports a live read-only stdio mode when local verification
  passes.
- Spreadsheet examples use stable public v3 API routes.
- Vendor audit and conformance reports are technical compatibility reports.
- Future-sensitive outputs preserve review-required and not-authority
  boundaries.
