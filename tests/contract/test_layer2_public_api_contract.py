"""Layer 2 public API reliability contract checks."""
...
def test_layer2_core_public_endpoints_have_stable_shapes() -> None:
...
def test_layer2_public_errors_have_stable_envelope() -> None:
...
def test_layer2_public_openapi_lists_core_surfaces() -> None:
