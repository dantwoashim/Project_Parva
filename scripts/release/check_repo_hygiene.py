...
def _tracked_path_issue(path: str) -> str | None:
    ...
    allowed_report_prefixes = (
        ...
        "reports/conformance/",
        "reports/ephemeris_accuracy/",
        "reports/external/",
        "reports/external_reviewer_dry_run/",
        "reports/panchanga/",
        "reports/phase_07_future_bs_governance/",
        "reports/phase_08_performance_sre/",
        "reports/phase_09_frontend_sdk_dx/",
        "reports/proof_contract/",
        "reports/red_check_closure/",
        "reports/release/",
        "reports/samples/",
        "reports/source_coverage/",
    )
    if path in allowed_reports or path.startswith(allowed_report_prefixes):
        return None
